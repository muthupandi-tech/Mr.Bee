...
async function main() {
  ...
  // Clean up existing data (Cascade will handle most)
  ...
  const superAdmin = await prisma.user.create({
    data: {
      ...
      // Super admin might not belong to a specific college, but we can leave it null or assign it.
    },
  });
  ...
  // 6. Create Navigation Graph (Nodes and Edges)
