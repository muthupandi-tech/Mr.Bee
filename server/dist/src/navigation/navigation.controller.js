...
let NavigationController = class NavigationController {
    ...
    async getPath(startRoomId, endRoomId) {
    ...
    async saveLayout(body) {
        const { floorId, rooms, nodes, edges } = body;
        if (!floorId) {
            return { error: 'floorId is a required parameter.' };
        }
        return this.navigationService.saveLayout(floorId, rooms || [], nodes || [], edges || []);
    }
};
exports.NavigationController = NavigationController;
__decorate([
    (0, common_1.Get)('path'),
    __param(0, (0, common_1.Query)('startRoomId')),
    __param(1, (0, common_1.Query)('endRoomId')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], NavigationController.prototype, "saveLayout", null);
